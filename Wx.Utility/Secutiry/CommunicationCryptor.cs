...
namespace Wx.Utility.Secutiry
{
    ...
    public class CommunicationCryptor
    {
        ...
        private static readonly string Separator = Convert.ToBase64String(Encoding.UTF8.GetBytes("#@|OneCard|@#"));
        ...
        public CommunicationCryptor(string ownPrivateKey, string facePublicKey, string hashType)
        {
            ...
            hashType.Required(str => hashType == "MD5" || hashType == "SHA1", Resource.Security_RSA_Sign_HashType);
